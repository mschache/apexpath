...
define(['./workbox-137dedbd'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.oik32ftv86"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https?:\/\/localhost:8000\/api\/(?!auth).*/i, new workbox.NetworkFirst({
    "cacheName": "api-cache",
  ...
  workbox.registerRoute(/^https:\/\/.*\.cloudfront\.net\/.*/i, new workbox.CacheFirst({
